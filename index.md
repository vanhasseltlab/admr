...
> **⚠ Deprecated:** `admr` is no longer maintained. Please use the
> successor package
> [**admixr2**](https://github.com/LeidenPharmacology/admixr2) instead.
> Install with: `devtools::install_github("LeidenPharmacology/admixr2")`

[⚠ Go to admixr2 (successor
package)](https://github.com/LeidenPharmacology/admixr2)
...
[LICENSE](https://vanhasseltlab.github.io/admr/LICENSE) file for
details.
