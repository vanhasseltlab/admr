...
```
    ...
    ## 
    ## Chain 1 Complete: Final NLL = -1796.484, Time Elapsed = 25.41 seconds
    ##  
    ...
    ## 
    ## Chain 2 Complete: Final NLL = -1796.484, Time Elapsed = 29.97 seconds
    ## 
...
```
    ...
    ## 
    ## -- Timing Information --
    ##      Best Chain: 25.4094 seconds
    ##      All Chains: 55.3792 seconds
    ##      Covariance: 43.0685 seconds
    ##         Elapsed: 98.45 seconds
    ## 
