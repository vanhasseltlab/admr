...
> **&#9888; Deprecated:** `admr` is no longer maintained. Please use the successor package [**admixr2**](https://github.com/LeidenPharmacology/admixr2) instead.
> Install with: `devtools::install_github("LeidenPharmacology/admixr2")`

<a href="https://github.com/LeidenPharmacology/admixr2" class="btn btn-warning btn-lg" role="button">&#9888; Go to admixr2 (successor package)</a>
...
-   [Getting Started](https://vanhasseltlab.github.io/admr/articles/getting_started.html)
-   [Other vignettes](https://vanhasseltlab.github.io/admr/articles/)
-   [Function Reference](https://vanhasseltlab.github.io/admr/reference/index.html)
